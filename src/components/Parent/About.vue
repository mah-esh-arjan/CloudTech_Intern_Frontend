    ...
    <div id="sticky-banner" tabindex="-1"
        ...
        <div class="flex items-center mx-auto">
            <p class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
                ...
                <span>Heading for the <a
                        class="inline font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">About
                        Us Main</a></span>
            </p>
        </div>
        ...
        <RouterLink :to="`/about/company`">Our company</RouterLink>
    </div>
    <RouterView />
</template>